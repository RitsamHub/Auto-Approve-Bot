        ...
        reply_markup=InlineKeyboardMarkup([
            [
                InlineKeyboardButton(
                    ...
                    url="https://telegram.me/{client.me.username}?startgroup=true&admin=invite_users"
                )
            ],
            [
            ...
            [
                InlineKeyboardButton(
                    ...
                    url="https://telegram.me/{client.me.username}?startchannel=true&admin=invite_users"
                )
            ]
        ])
    )
